" This file defines the initial conditions eta_0(x,y) and Phi_0(x,y), and is called by file BL_periodic.py. "
...
" • Function initial_phib provides values of Phi_0 on x=x1 or x=x2 for SP3. "
" • Function initial_phiby provides values of (Phi_0)_y on x=x1 or x=x2 for SP3. "
" • Function initial_phib2 provides values of Phi_0 on x=x1 or x=x2 for SP2. "
" • Function initial_phiby2 provides values of (Phi_0)_y on x=x1 or x=x2 for SP2. "
...
def initial_phiby(xx,yy,k1,k2,k3,k4,k5,k6,t,ep,mu):
    ...
    phi = ((8)**(1/6)*(ep)**(0.5)*(2*(uxy/d1-(u1/d1)*(uy/d1))))
