...
# python training2pressure00.py --equation NS3d --blocks 0 --file 5N19 --epochs 10 --ks 9 --filters 3 --dt 0.01  --forcing sigma5  --ndt 1 --eps 1.0 --order 1 --kind force3d --path 20_20251226T16
import torch
import time
import datetime
import os
