...
if os.path.isdir(data_path) == False: 
   ...
   try:
       subprocess.run(f'python ns_solver.py --case train --Nsamples 600 --Ntimes 3 --Equation {Equation}', shell=True)
       subprocess.run(f'python ns_solver.py --case test --Nsamples 100 --Ntimes 3 --Equation {Equation}', shell=True)
